...
?>
    ...
    <div class="container mt-5">
        ...
        <div class="nota bg-white">
            ...
            <p>
                Ao(s) <span class="linha d-inline-block w-25"></span> dia(s) do mês de
                <span class="linha d-inline-block w-25"></span> de
                <span class="linha d-inline-block w-25"></span>,
                pagarei por esta única via de <strong>NOTA PROMISSÓRIA</strong> a quantia de
                <strong>R$ 1.000,00</strong> a
            </p>

            <p>
                <span class="linha d-inline-block w-75"></span>
            </p>
            ...
            <div class="row mt-5">
                <div class="col-md-6">
                    <p><strong>Local:</strong> São José do Rio Preto</p>
                </div>

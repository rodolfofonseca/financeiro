...
/**
 * Rota responsável por pesqusiar os pedidos no sistema
 */
router_add('pesquisar_pedidos', function(){
    ...
    echo json_encode(['dados' => $retorno_final], JSON_UNESCAPED_UNICODE);
});

/**
 * Rota responsável por mostrar os pedidos de entrada.
 */
router_add('entrada', function () {
    include_once 'includes/head.php';
    ?>
    <script>
        const EMPRESA = "<?php echo EMPRESA; ?>";
...
/**
 * Rota responsável por realizar o cadastro dos pedidos de entrada
 */

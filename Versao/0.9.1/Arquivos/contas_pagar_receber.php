...
router_add('index', function () {
    ...
    ?>
        <script>
            ...
            function pesquisar_contas() {
                ...
                sistema.request.post('/contas_pagar_receber.php', {
                    ...
                    function processar_item() {
                        ...
                        if(conta.status_conta != 'PAGO'){
                            ...
                            botao.addEventListener('click', function () {
                                if (nome_usuario == '' || conta.transacao == '') {
                                    ...
                                    document.querySelector('#valor_conta').value = sistema.number_format(conta.valor_conta, 2, ',');
                                    document.querySelector('#data_vencimento').value = sistema.retornar_data(conta.data_vencimento, false, 'us');

                                    console.log(sistema.retornar_data(conta.data_vencimento, false, 'us'));
                                }
                            });
                        ...
                        let botao_boleto = gerar_botao_boleto(conta);
                        
                        if (botao_boleto.status == true) {
                            let linha_anexar_boleto = document.createElement('li');
                            
                            if (botao_boleto.botao == 'ANEXAR') {

                                linha_anexar_boleto.appendChild(sistema.gerar_a(
                                    'Anexar Boleto',
                                    ['dropdown-item'],
                                    function () {
                                        document.querySelector('#codigo_local').value =
                                            conta.codigo_conta_pagar_receber;
                                        document.querySelector('#nome_conta_anexo_documentos').value = conta.nome_conta;
                                    },
                                    {
                                        'data-bs-toggle': 'modal',
                                        'data-bs-target': '#modal_anexar_documentos'
                                    }
                                ));

                            } else if (botao_boleto.botao == 'BAIXAR') {

                                linha_anexar_boleto.appendChild(
                                    sistema.gerar_a(
                                        'Baixar Boleto',
                                        ['dropdown-item'],
                                        botao_boleto.funcao
                            ...
                            ul_acao.appendChild(linha_anexar_boleto);
                        }

                        let botao_comprovante = gerar_botao_comprovante(conta);
                        
                        if (botao_comprovante.status == true) {

                            let linha_comprovante = document.createElement('li');
                            
                            if (botao_comprovante.botao == 'COMPROVANTE') {
                                linha_comprovante.appendChild(sistema.gerar_a('Anexar Comprovante', ['dropdown-item'], botao_comprovante.funcao), {
                                    'data-bs-toggle': 'modal',
                                    'data-bs-target': '#modal_anexar_documentos'
                                });
                            } else if (botao_comprovante.botao == 'BAIXAR') {
                                linha_comprovante.appendChild(sistema.gerar_a('Baixar Comprovante', ['dropdown-item'], botao_comprovante.funcao));
                            }

                            ul_acao.appendChild(linha_comprovante);
                        }

                        let botao_editar_conta = gerar_botao_editar(conta);

                        if(botao_editar_conta.status == true){
                            let linha_editar_conta = document.createElement('li');
                            linha_editar_conta.appendChild(sistema.gerar_a('Editar Conta', ['dropdown-item'], botao_editar_conta.funcao));

                            ul_acao.appendChild(linha_editar_conta);
                        }
            ...
            /**
             * Função responsável por validar se irá aparecer o botão de editar a conta ou não.
             */
            function gerar_botao_editar(conta) {
                if (conta.status_conta == 'PAGO') {
                    return { status: false };
                } else {
                    return { status: true, funcao: function(){
            ...
            /**
             * Função responsável por validar o botão de cadastrar anexo ou o de baixar anexo
             */
            function gerar_botao_comprovante(conta) {
                if (conta.status_conta == 'PAGO') {
                        ...
                        if (conta.comprovante == 'NAO') {
                            return {
                                ...
                                funcao: function () {
                                    ...
                                    let modal = new bootstrap.Modal(document.querySelector('#modal_anexar_documentos'));

                                    modal.show();
                                }
                            };
                        } else if (conta.comprovante == 'SIM') {
                            return {
                                status: true,
                                botao: 'BAIXAR',
                                funcao: function () {
            ...
            /**
             * Função responsável por validar se tem que gerar o botão de anexar boleto ou baixar o boleto
             */
            function gerar_botao_boleto(conta) {
                        ...
                        if (conta.boleto == 'NAO') {
                            ...
                            return {
                                ...
                                funcao: function () {
                                    ...
                                    document.querySelector('#nome_conta_anexo_documentos').value =
                                        conta.nome_conta;

                                    document.querySelector('#empresa_anexo_documento').value =
                                        EMPRESA;
                                    document.querySelector('#local_documento').value = 'CONTAS_PAGAR_RECEBER_BOLETOS';
                                    let modal = new bootstrap.Modal(
                                        document.querySelector('#modal_anexar_documentos')
                                    );
                            ...
                            return {
                                ...
                                funcao: function () {
                                    ...
                                    abrir_modal_download_arquivo(
                                        conta.codigo_conta_pagar_receber,
                                        'CONTAS_PAGAR_RECEBER_BOLETOS'
                                    );
        ...
        <div class="page-wrapper">
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <table class="table table-nowrap text-nowrap table-hover" id="tabela_contas">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="16" class="text-center">UTILIZE O FILTRO PARA FACILITAR
                                                            A PESQUISA!</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-center">
                                    ...
                                    <input type="date" class="form-control" id="data_vencimento" readonly="true">
                                </div>
                            </div>
                            <br />
                            <div class="row">
            ...
            <div class="modal fade" id="modal_anexar_documentos" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
...
router_add('cadastro_contas', function () {
    ...
    ?>
            <script>
                 ...
                 */
                async function pesquisar_cliente_fornecedor() {
                    sistema.request.post('/clientes.php', {
                        'rota': 'pesquisar_clientes',
                        'empresa': EMPRESA,
                        'tipo_usuario': ''
            ...
            <div class="page-wrapper">
                ...
                <script>
                    window.onload = async () =>{
                        ...
                        await pesquisar_cliente_fornecedor();

        ...
        if (empty($extrato) == false) {
            ...
            if(empty($usuario) == false){
                if(empty($conta_fornecedor) == false){
                    ...
                    // file_put_contents('usuario.json', json_encode(['usuario' => $usuario, 'conta_fornecedor' => $conta_fornecedor, 'array_cadastro' => $array_cadastro_conta_pagar_receber, 'retorno_cadastro' => $retorno_conta_pagar_receber]));

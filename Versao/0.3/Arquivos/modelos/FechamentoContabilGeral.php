...
class FechamentoContabilGeral implements InterfaceModelo
{
    ...
    {
        return (array) ['empresa' => 'objectId', 'ano_referencia' => (int) 0, 'mes_referencia' => (int) 0, 'total_credito' => (double) 0, 'total_debito' => (double) 0, 'valor_resultado' => (double) 0, 'resultado' => (string) '', 'data_fechamento' => 'date'];
    }

...
router_add('pesquisar_nota_fiscal', function () {
    ...
    $filtro = (array) ['filtro' => (array) [], 'ordenacao' => (array) ['data_nota' => (bool) false,], 'limite' => (int) 0];
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3 text-center">
                                    ...
                                    <select class="form-control" id="cliente_fornecedor" id="cliente_fornecedor">
                            ...
                            <div class="card-body">
                                <form method="POST" accept="nota_fiscal.php" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-3 text-center">
                                            <label class="text">Cliente/Fornecedor</label>
                                            <select class="form-control" name="cliente_fornecedor" id="cliente_fornecedor">
                                                <option value="">Selecione uma Opção</option>
                                            </select>
                                        </div>
                                        <div class="col-2 text-center">

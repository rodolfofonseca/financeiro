    ...
    public function salvar_dados($dados)
    {
        ...
        if ($this->codigo_empresa == null) {
            ...
            if ($retorno_checagem == false) {
                return (bool) model_insert((string) $this->tabela(), (array) ['nome_empresa' => (string) $this->nome_empresa, 'nome_fantasia' => (string) $this->nome_fantasia, 'cnpj' => (string) $this->cnpj, 'endereco' => (string) $this->endereco, 'data_cadastro' => $this->data_cadastro, 'cidade' => (string) $this->cidade]);
            } else {
                return (bool) false;
            }
        } else {
            return (array) model_update((string) $this->tabela(), (array) ['_id', '===', $this->codigo_empresa], (array) ['nome_empresa' => (string) $this->nome_empresa, 'nome_fantasia' => (string) $this->nome_fantasia, 'cnpj' => (string) $this->cnpj, 'endereco' => (string) $this->endereco, 'data_cadastro' => $this->data_cadastro, 'cidade' => (string) $this->cidade]);
        }
    }

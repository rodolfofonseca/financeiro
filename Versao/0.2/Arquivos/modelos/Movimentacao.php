...
class Movimentacao implements InterfaceModelo
{
    ...
    {
        return (array) ['conta' => 'objectId', 'empresa' => 'objectId', 'tipo_lancamento' => (string) '', 'valor_lancamento' => (double) 0, 'data_lancamento' => 'date', 'descricao' => (string) ''];
    }
    ...
    public function salvar_dados($dados)
    {
        ...
        if ($this->tipo_lancamento == 'CREDITO' || $this->tipo_lancamento == 'DEBITO') {
            if ($this->codigo_movimentacao == null) {
                $retorno_movimentacao = (bool) model_insert((string) $this->tabela(), (array) ['empresa' => $this->empresa, 'conta' => $this->conta, 'tipo_lancamento' => (string) $this->tipo_lancamento, 'valor_lancamento' => (float) $this->valor_lancamento, 'descricao' => (string) $this->descricao, 'data_lancamento' => $this->data_lancamento]);
            } else {
                $retorno_movimentacao = (bool) model_update((string) $this->tabela(), (array) ['_id', '===', $this->codigo_movimentacao], (array) ['empresa' => $this->empresa, 'conta' => $this->conta, 'tipo_lancamento' => (string) $this->tipo_lancamento, 'valor_lancamento' => (float) $this->valor_lancamento, 'descricao' => (string) $this->descricao, 'data_lancamento' => $this->data_lancamento]);
            }
            ...
            $retorno_movimentacao = (bool) model_insert((string) $this->tabela(), (array) ['empresa' => $this->empresa, 'conta' => $this->conta, 'tipo_lancamento' => (string) 'TRANSFERENCIA_DEBITO', 'valor_lancamento' => (float) $this->valor_lancamento, 'descricao' => (string) $this->descricao, 'data_lancamento' => $this->data_lancamento]);
            $retorno_movimentacao = (bool) model_insert((string) $this->tabela(), (array) ['empresa' => $this->empresa, 'conta' => $this->conta_destino, 'tipo_lancamento' => (string) 'TRANSFERENCIA_CREDITO', 'valor_lancamento' => (float) $this->valor_lancamento, 'descricao' => (string) $this->descricao, 'data_lancamento' => $this->data_lancamento]);

            $resultado_conta = (float) arredondar($resultado_conta, '-', $retorno_conta['saldo_conta']);

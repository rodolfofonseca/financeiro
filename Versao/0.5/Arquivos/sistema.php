...
router_add('index', function () {
    ...
    <div class="page-wrapper">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-1 text-center">
                                    ...
                                    <select class="form-control" id="google_agenda">
                                        <option value="0">NÃO</option>
                                        <option value="1">SIM</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-3 text-center">
                                    ...
                                    <button class="btn btn-info w-100" data-bs-toggle="modal"
                                        data-bs-target="#modal_cadastro_json_google">CARREGAR JSON GOOGLE</button>
                                </div>
                                <div class="col-3 text-center">
                                ...
                                <div class="col-3 text-center">
                                    <label class="text">CNPJ</label>
                                    <input type="text" class="form-control" id="cnpj" sistema-mask="cpf-cnpj">
                                </div>
                            </div>
                            <br />
                            <div class="row">
        ...
        <div class="modal fade" id="modal_cadastro_json_google" tabindex="-1" role="dialog"
            aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">Cadastro Json Google</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <form method="POST" accept="sistema.php" enctype="multipart/form-data">
                                <div class="col-12 text-center">
                                    <label class="text">Faça o upload do arquivo JSON da Google Agenda para integrar a sua
                                        agenda com o sistema. <strong>google.json</strong></label>
                                    <input type="hidden" name="rota" value="SALVAR_DADOS_GOOGLE_AGENDA">
                                    <input type="hidden" name="empresa" value="<?php echo EMPRESA; ?>">
                                    <input type="file" name="json_google" class="form-control">
                                </div>
                                <div class="col-12 text-center">
                                    <?php include_once 'includes/botao_cadastro_form.php'; ?>
                                </div>
                            </form>
                        </div>
                    </div>

...
class ContasFornecedores implements InterfaceModelo{
    ...
    public function inativar_conta_fornecedor($dados){
        ...
        array_push($filtro_montando, ['fornecedor', '===', model_id($dados['fornecedor'])]);

        $retorno = (bool) model_update((string) $this->tabela(), (array) ['and' => (array) $filtro_montando], (array) ['status_conta' => (bool) $dados['status']]);
    }
}
?>
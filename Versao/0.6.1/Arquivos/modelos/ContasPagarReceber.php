...
;    }
  ...
  AND data_vencimento BETWEEN :inicio AND :fim
    ...
    public function somar_conta_vencida($codigo_empresa){
        $query = (string) "select sum(valor_conta) as valor_total_contas, count(*) as quantidade_contas from conta_pagar_receber where codigo_empresa = :empresa and status_conta = 'VENCIDA';";

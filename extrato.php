...
router_add('pesquisar_todos_extratos', function () {
    ...
    $retorno_extrato = (array) $objeto_extrato->pesquisar_todos((array) ['filtro' => (array) ['and' => (array) $filtro_montado], 'ordenacao' => (array) ['data_extrato' => (bool) false], 'limite' => (int) 0]);
    $retorno = (array) [];
...
router_add('imprimir_extrato', function () {
    ...
    $total_proventos = (double) 0;
    $total_descontos = (double) 0;
    $total_liquido = (double) 0;
?>
    <style>
        @media print {
            .no-print {
    ...
    <div class="container mt-4">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                $total_liquido = (double) arredondar($total_proventos, '-', $total_descontos);
                ?>
            </tbody>
        </table>
        ...
        function pesquisar_extrato() {
            sistema.request.post('/extrato.php', {
                ...
                if (tamanho_retorno == 0) {
                    ...
                    linha.appendChild(sistema.gerar_td(['text-center'], 'NENHUM EXTRATO ENCONTRADO!', 'inner', true, 10));
                    ...
                    sistema.each(extratos, function(index, extrato) {
                        ...
                        linha.appendChild(sistema.gerar_td(['text-center'], sistema.retornar_data(extrato.data_extrato), 'inner'));

                        if (extrato.status == 'PAGO') {
                            linha.appendChild(sistema.gerar_td(['text-center'], sistema.retornar_data(extrato.data_pagamento), 'inner'));
                        } else {
                            linha.appendChild(sistema.gerar_td(['text-center'], '', 'inner'));
                        }

                        linha.appendChild(sistema.gerar_td(['text-center'], sistema.number_format(extrato.valor_bruto), 'inner'));
                        linha.appendChild(sistema.gerar_td(['text-center'], sistema.number_format(extrato.valor_entrada), 'inner'));
                        linha.appendChild(sistema.gerar_td(['text-center'], sistema.number_format(extrato.valor_desconto), 'inner'));
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table class="table table-nowrap text-nowrap table-hover" id="tabela_extratos">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="10" class="text-center">NENHUM EXTRATO ENCONTRADO COM OS FILTROS PASSADOS</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-4 text-center">
                                        ...
                                        <select class="form-control" id="usuario" onblur="pesquisar_usuario_selecionado();">

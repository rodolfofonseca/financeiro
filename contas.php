...
<script>
    ...
    function cadastro_contas(codigo_conta){
        window.location.href = sistema.url('/contas.php', {'rota':'cadastro_contas', 'codigo_conta':codigo_conta});
        }
        ...
        function pesquisar_contas(){
            ...
            sistema.request.post('/contas.php', {'rota':'pesquisar_contas', 'empresa':CODIGO_EMPRESA,'nome_conta':nome_conta, 'descricao':descricao, 'status':status}, function(retorno){
                ...
                if(tamanho_retorno == 0){
                    ...
                    sistema.each(contas, function(index, conta){
                        ...
                        div.appendChild(sistema.gerar_botao('botao_visualizar_'+conta._id.$oid, 'EDITAR',['btn', 'btn-info'], function editar(){cadastro_contas(conta._id.$oid);}, 'append'));
...
router_add('cadastro_contas', function(){
    ...
    <script>
        ...
        function salvar_dados(){
            ...
            sistema.request.post('/contas.php', {'rota':'salvar_dados', 'codigo_conta':CODIGO_CONTA, 'empresa':EMPRESA,'nome_conta':nome_conta, 'descricao':descricao, 'saldo_conta':saldo_conta}, function(retorno){
    ...
    <div class="page-wrapper">
        ...
        <script>
            window.onload = function (){
                if(CODIGO_CONTA != ''){
                    sistema.request.post('/contas.php', {'rota':'pesquisa_conta', 'codigo_conta':CODIGO_CONTA}, function(retorno){

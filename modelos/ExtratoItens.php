...
class ExtratoItens implements InterfaceModelo{
    ...
    public function salvar_dados($dados)
    {
        ...
        if($this->codigo_extrato_item != null){
            ...
            $retorno_operacao = (bool) model_insert((string) $this->tabela(), (array) ['extrato' => $this->extrato, 'item_extrato' => $this->item_extrato, 'valor_lancamento_extrato' => (double) $this->valor_lancamento_extrato]);
        }        

...
class Movimentacao implements InterfaceModelo{
    ...
    public function colocar_dados($dados)
    {
        ...
        $this->tipo_lancamento = (string) (isset($_REQUEST['tipo_lancamento']) ? (string) $dados['tipo_lancamento']:'CREDITO');
    }
    ...
    public function salvar_dados($dados)
    {
        ...
        if($this->codigo_movimentacao == null){
            $retorno_movimentacao = (bool) model_insert((string) $this->tabela(), (array) ['conta' => $this->conta, 'tipo_lancamento' => (string) $this->tipo_lancamento, 'valor_lancamento' => (double) $this->valor_lancamento, 'descricao' => (string) $this->descricao, 'data_lancamento' => $this->data_lancamento]);
        }else{
            $retorno_movimentacao = (bool) model_update((string) $this->tabela(), (array) ['_id', '===', $this->codigo_movimentacao], (array) ['conta' => $this->conta, 'tipo_lancamento' => (string) $this->tipo_lancamento, 'valor_lancamento' => (double) $this->valor_lancamento, 'descricao' => (string) $this->descricao, 'data_lancamento' => $this->data_lancamento]);
        }

    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            if ($retorno_contas_vencidas[0]['quantidade_contas'] > 0) {
                ...
                if ($retorno_contas_vencidas[0]['quantidade_contas'] >= 1) {
                        ...
                        <div class="col-lg-8 col-md-9 col-sm-7">
                            <div>
                                ...
                                <p class="text-white mb-3">Você possui o total de (<strong>
                                        <?php echo $retorno_contas_vencidas[0]['quantidade_contas']; ?> </strong>) vencidas no
                                    valor total de R$:
                                    <strong><?php echo formatar_numero($retorno_contas_vencidas[0]['valor_total_contas'], 2, ',', '.'); ?></strong>
                                </p>
